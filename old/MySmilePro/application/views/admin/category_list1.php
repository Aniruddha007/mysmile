...
$userList = $this->admin_common_model->get_where('procedure_list',['type'=>'Condition']);
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Condition List</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                              ...
                                              $date_time  = date("Y-m-d g:i a", strtotime($row['date_time']));
                                                            ...
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_category1/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>   </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
