...
$userList = $this->admin_common_model->get_all('plans');
...
-->                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">Plan Type List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Plan Type List</h3>
                                    </div>
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'plans', 'id': id}, // change this to send js object
          type: "POST",
