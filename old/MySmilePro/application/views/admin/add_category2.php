<?php include 'include/header.php';?>
  ...
  $button = "submit";
      $btn_name = "Add Patient Health Record";
      $path = base_url("assets/images/banner/user_b.png");
      $id = $this->uri->segment(4);
      if($id!=''){
        $fetch = $this->admin_common_model->get_where('profile_question',['id'=>$id]);
        $row = $fetch[0];
        $button = "update";
        $btn_name = "Update Patient Health Record";        
        if($row['image']!=''){
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                echo $fetch_app_name[0]['app_name']; ?></a></li>
                                    <li class="active">Add Patient Health Record</li>
                                </ol>
                            </div>
                        </div>
...
<form method="POST" action="" enctype="multipart/form-data">
          <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <?php if($row['id']){?>
                                    <div class="panel-heading"><h3 class="panel-title">Update Patient Health Record</h3></div>
                                    <?php }else{?>
                                    <div class="panel-heading"><h3 class="panel-title">Add Patient Health Record</h3></div>
                                    <?php }?>
 ...
 <a href="<?=base_url('admin/view_page/category_list2');?>">
...
$result = $this->admin_common_model->insert_data('profile_question',$arr_data); 
...
"<script> swal(
  'Success',
  'Add Patient Health Record Successfully',
  'success'
...
$('.confirm').click(function(){
        ...
        window.location='".base_url('admin/view_page/category_list2')."';
});
...
echo "<script> swal(
  'Error',
  'Error In Add Patient Health Record',
  'error'
); 
...
$result = $this->admin_common_model->update_data('profile_question',$arr_data, $arr_where); 
//echo $this->db->last_query(); die;
...
"<script> swal(
  'Success',
  'Update Patient Health Record Successfully',
  'success'
); 
...
echo "<script> swal(
  'Error',
  'Error In Updating Patient Health Record',
  'error'
); 
