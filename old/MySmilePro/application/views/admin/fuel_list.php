...
$userList = $this->admin_common_model->get_all('fuels');
...
-->                                <ol class="breadcrumb pull-right">
                                    <li><a href="<?=base_url('admin/view_page/dashboard');?>">Fuel</a></li>
                                    <li class="active">Fuel List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Fuel List</h3>
                                    </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                              ...
                                              <?php $i=2; foreach($userList as $row){ ?>
                                                        ...
                                                        <tr>
                                                            <td><?= $row['fuel_name']; ?></td>
                                                            <td><?= $row['price']; ?></td>
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_plan/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>   </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'fuels', 'id': id}, // change this to send js object
          type: "POST",
