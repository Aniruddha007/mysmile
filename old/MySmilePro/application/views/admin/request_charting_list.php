...
$userList = $this->admin_common_model->get_all('user_request_charting');
//$userList = $this->admin_common_model->get_where('place_bid',['remove_status'=>'No','user_id'=>$id]);
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                echo $fetch_app_name[0]['app_name']; ?></a></li>
                                    <li class="active">Charting List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Charting List</h3>
                                    </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                              ...
                                              ?>
                                                        ...
                                                        <!--   <td> 
                                                            ...
                                                            <td><a href="<?=base_url('admin/view_page/user_request_charting_images/'.$row['id']);?>"><button type="button" class="btn btn-purple waves-effect waves-light" >Images</button></a>
</td>
