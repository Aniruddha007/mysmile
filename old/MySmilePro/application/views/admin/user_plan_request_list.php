<?php include 'include/header.php';?>
  ...
  $arr_get1 = ['status'=>'Pending'];
         ...
         $req = $this->admin_common_model->get_where('plan_request',$arr_get1);
...
-->                               
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">User Plan Request</li>
                                </ol>
                            </div>
                        </div>
...
<div class="row">
                        ...
                        <div style="height: 0px;">           <a href="<?=base_url('admin/view_page/user_plan_request_list');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Refresh</button></a>
</div>
            <div class="datew-times">
                    ...
                    <b> To: </b><input type="text" name="from" id="max" placeholder="12-04-2017 12:52 PM" class="form-control">
                      ...
                      $plan = $this->admin_common_model->get_where('plan_type',['id'=>$row['plan_id']]);
                                   ...
                                   ?>
                                        ...
                                        <td><select name="status" getId1="<?=$row[id];?>"   style="height: auto !important;">
											...
											<option <?php if($row['status']=='Accept'){ echo 'selected'; } ?>>Accept</option> 
											<option  <?php if($row['status']=='Reject'){ echo 'selected'; } ?>>Reject</option>
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'plan_request', 'id': id}, // change this to send js object
          type: "POST",
...
$('select').change(function () { 
       ...
       var status = $(this).val();
    // alert(getId);
        url = "<?php echo base_url().'admin/upt_driver_stts_request_p'?>"; 
                $.ajax({
                  type:"POST",
                  url: url, 
