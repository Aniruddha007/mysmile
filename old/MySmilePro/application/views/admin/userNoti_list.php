...
$userList = $this->db->query("SELECT * FROM notification WHERE type = 'USER' AND notification_type = 'Admin' group by code order by id desc")->result_array();
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                echo $fetch_app_name[0]['app_name']; ?></a></li>
                                    <li class="active">Patient Notification List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Patient Notification List</h3>
                                    </div>
                                    <div class="panel-body">
                                        
                                        
                                             <section class="content">
    <form action="<?php echo base_url(); ?>admin/goUserNoti" method="POST" id="bulk_form" onsubmit="delete_confirm()">


      <a href="<?=base_url('admin/view_page/add_userNoti');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Add New Notification</button></a>
...
-->
    <td class="text-center">
                                                              <a href="<?=base_url('admin/view_page/add_userNoti/'.$row['id']);?>">
