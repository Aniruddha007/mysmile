...
//$userList = $this->admin_common_model->get_where('users',[type=>'USER']);
              ...
              $userList = $this->db->query("SELECT * FROM users WHERE type = 'USER' AND exp_date > '$date'")->result_array();
...
-->                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active"></li>Corporate User List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Corporate User List</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                              ...
                                              $i=2; foreach($userList as $row){ 
                                                   $plan_type = $this->admin_common_model->get_where('plans',['id'=>$row['plan_id']]);
