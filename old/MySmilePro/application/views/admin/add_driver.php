<?php include 'include/header.php';?>
    ...
    <body class="fixed-left">
      ...
      $button = "submit";
      $btn_name = "Add Provider";
      $id = $this->uri->segment(4);
      if($id!=''){
        $fetch = $this->admin_common_model->get_where('users',['id'=>$id]);
        $row = $fetch[0];
        $button = "update";
        $btn_name = "Update Provider";        
        if($row['store_logo']){
          $path = base_url("uploads/images/".$row['store_logo']);
        }else{
        ...
        if($row['licence_image']){
          ...
          $path1 = base_url("assets/images/banner/user_b.png");
                       ...
                       $cat_list = $this->admin_common_model->get_where('category',['remove_status'=>'No']);
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Add Provider</h4>
...
<form method="POST" action="" enctype="multipart/form-data">
          <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Provider Information</h3></div>
             ...
             <!--
                <div class="form-group">
                                                <label>Code *</label>
                                               <select class="form-control" id="" name="countryCode" required>
          ...
          <div class="form-group">
            <label>Clinic Logo</label><br>
              
                 <img src="<?=$path;?>" width="100" height="100" id="store_logo">
                 <input type="file"   name="store_logo" onchange="readURL(this,'store_logo');" style="display:block">
                                           ...
                                           <!--  <div class="form-group">
                                                ...
                                                <input type="text"  class="form-control" name="vehicle" required value="<?=$row['vehicle'];?>">
                                                                         ...
                                                                         <input type="hidden"  class="form-control" name="type" required value="PROVIDER">
                    ...
                    <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Document Information</h3></div>
              ...
              <?php foreach($cat_list as $arr){ ?>
                 <option <?php if($row['cat_id']==$arr['id']){echo "selected"; } ?> value="<?=$arr['id'];?>"> <?=$arr['name'];?> </option>
              <?php } ?>
                                               </select>
                                            </div>-->
       ...
       <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="store_name"  value="<?=$row['store_name'];?>">
                                            </div>
               ...
               <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="about_store"  value="<?=$row['about_store'];?>">
                                            </div>
...
<!--
  <div class="form-group">
                                                ...
                                                <input type="text"  class="form-control" name="tax_number"  value="<?=$row['tax_number'];?>">
                                            </div>
...
-->
  ...
  <div class="form-group">
            <label>Vehicle Image</label><br>
                 <img src="<?=$path2;?>" width="100" height="100" id="vehicle_image">
                 <input type="file"  name="vehicle_image" onchange="readURL(this,'vehicle_image');" style="display:block">
          </div>



   <div class="form-group">
            <label> Insurance Image</label><br>
          ...
          <div class="form-group">
            <label>Registration Image</label><br>
                 <img src="<?=$path4;?>" width="100" height="100" id="registration_image">
                 <input type="file"  name="registration_image" onchange="readURL(this,'registration_image');" style="display:block">
          </div>
          -->
...
$countryCode = $arr_data['countryCode'];
$mobile = $arr_data['mobile'];

$new ='';// $countryCode.$mobile;
...
unset($arr_data['submit'],$arr_data['id'],$arr_data['countryCode']);
...
unset($arr_data['update'],$arr_data['countryCode']);
