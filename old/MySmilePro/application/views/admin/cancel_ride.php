...
-->                               
                                ...
                                echo $fetch_app_name[0]['app_name']; ?></a></li>
                                    <li class="active">Cancelled Request</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">JUST CANCELLED , NOT YET BOOKED REQUEST</h3>
                                    </div>
                                    <div class="panel-body">
                                        
                                          <section class="content">
    <form action="<?php echo base_url(); ?>admin/goRequest4" method="POST" id="bulk_form" onsubmit="delete_confirm()">
