...
?>
 ...
 $fetch = $this->admin_common_model->get_where('users',['type'=>'DRIVER','available_status'=>'ONLINE','driver_type'=>'CABS','lat !='=>'','lon !='=>'']); 
//print_r($fetch);die;
?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">Request Radius Details</li>
                                </ol>
                            </div>
                        </div>
...
<div class="row">
 ...
 <script type="text/javascript">
    ...
    var locations = [
      ...
      ['<?=$val['username']?>',<?=$val['lat']?>,<?=$val['lon']?>, 4],
...
var marker_icon11 = {
      ...
      marker = new google.maps.Marker({
        position: new google.maps.LatLng(23.2599, 77.4126),
        map: map,
         icon:marker_icon11
      });
...
var marker_icon = {
                                 url: "http://ambitious.in.net/AMBE/uploads/images/user_marker.png",
                                 scaledSize: new google.maps.Size(25,31)};
      marker = new google.maps.Marker({
