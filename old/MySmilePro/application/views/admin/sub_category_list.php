...
$userList = $this->admin_common_model->get_where('sub_category',['remove_status'=>'No']);
                      ...
                      <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                        ...
                                        <div class="row">
											...
											<option <?php if($row['status']=='Deactive'){ echo 'selected'; } ?>>Deactive</option> 
                                                            ...
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_sub_category/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>   </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
