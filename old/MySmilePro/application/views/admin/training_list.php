...
$driverList = $this->admin_common_model->get_all('training');
...
?>
      ...
      <a href="<?=base_url('admin/view_page/ExUser?type=training');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Export csv</button></a>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Training List</h3>
                                    </div>
...
$car = $this->admin_common_model->get_where('car_list',['id'=>$row['car_id']]);?>

                                                        <tr>
                                                            <td><?= $row['title']; ?></td>
                                                            <td><?= $row['url']; ?></td>
                                                            <td><?= $row['date_time']; ?></td>
 <td class="text-center"><a href="<?=base_url('admin/view_page/add_training/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>   <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'training', 'id': id}, // change this to send js object
          type: "POST",
