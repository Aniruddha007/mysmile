                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    <thead>
                                                         <tr>
                                                            <th>Driver Name</th>
                                                            <th>Pay Insentive Amount</th>
                                                            <th>Ride Total Amount</th>
                                                        </tr>
                                                    </thead>
                                              ...
                                              <?php $i=2; foreach($driver_list as $row1){ 
                                                     if($apply_amount > $row1['total_amount']){
                                                         continue;
                                                     }
                                                     
$car = $this->admin_common_model->get_where('car_list',['id'=>$row['car_id']]);
$driver = $this->admin_common_model->get_where('users',['id'=>$row1['accept_driver_id']]);?>

                                                        <tr>
                                                            <td><?= $driver[0]['username']; ?></td>
