<?php include 'include/header.php';?>
    ...
    <body class="fixed-left">
       ...
       <?php include 'include/side_menu.php';
         ...
         $req = $this->admin_common_model->get_all('emergency_contact');
...
-->                               
                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">Emergency Contact Driver Details</li>
                                </ol>
                            </div>
                        </div>
...
<div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Emergency Contact Driver List</h3>
                                    </div>
                    ...
                    <input type="hidden" name="from" id="max" placeholder="12-04-2017 12:52 PM" class="form-control">
                      ...
                      $drivername = $this->admin_common_model->get_where('users',['id'=>$request[0]['accept_driver_id']]);
                      
                      $username = $this->admin_common_model->get_where('users',['id'=>$row['driver_id']]);
