...
$userList = $this->admin_common_model->get_where('users',[type=>'DOCTOR']);
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                              ...
                                              <?php $i=2; foreach($userList as $row){ ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $row['status']; ?></td>
                                                            <td><?= $row['date_time']; ?></td>
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_doctor/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>  <a href="<?=base_url('admin/view_page/view_doctor/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-eye"></i></a> </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
