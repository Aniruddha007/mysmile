...
//$driverList = $this->admin_common_model->get_where('users',['type'=>'PROVIDER','status'=>'Deactive']);

           $driverList = $this->db->query("SELECT * FROM users where status = 'Deactive' AND (type = 'PROVIDER' OR type = 'HYGIENIST' ) ")->result_array();
...
-->                               
                                ...
                                echo $fetch_app_name[0]['app_name']; ?></a></li>
                                    <li class="active">Provider Pending Application List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Provider Pending Application List</h3>
                                    </div>
                                    <div class="panel-body">
                                        
                                         <section class="content">
    <form action="<?php echo base_url(); ?>admin/goProDe" method="POST" id="bulk_form" onsubmit="delete_confirm()">
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    <thead>
                                                         <tr>
                                                            ...
                                                            <th>Status</th>
                                                            <th>Missing for<br>account Approve</th>
                            ...
                            <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $row['id']; ?>"/></td>  
										   ...
										   <option value="Active" <?php if($row['status']=='Active'){ echo 'selected'; } ?>>Approve</option>
                                                <option value="Deactive" <?php if($row['status']=='Deactive'){ echo 'selected'; } ?>>Disapprove</option>
                                                          ...
                                                          <td><a href="<?=base_url('admin/view_page/add_note/'.$row['id']);?>"><button type="button" class="btn btn-purple waves-effect waves-light" >Note</button></a>
</td>
