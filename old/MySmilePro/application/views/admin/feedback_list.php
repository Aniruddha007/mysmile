<?php include 'include/header.php';?>
    ...
    <body class="fixed-left">
       ...
       <?php include 'include/side_menu.php';
         ...
         $req = $this->admin_common_model->get_where('rating_review',['type'=>'USER']);
...
<div class="row">
    ...
    <form action="<?php echo base_url(); ?>admin/goFeedback" method="POST" id="bulk_form" onsubmit="delete_confirm()">
