...
<form method="POST" action="" enctype="multipart/form-data">
          <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <?php if($row['id']){?>
                                    <div class="panel-heading"><h3 class="panel-title">Update Procedure</h3></div>
                                    <?php }else{?>
                                    <div class="panel-heading"><h3 class="panel-title">Add Procedure</h3></div>
                                    <?php }?>
                                        ...
                                        <form role="form">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" required value="<?=$row['name'];?>">
                                                    ...
                                                    <input type="hidden" class="form-control" name="type" required value="Treatment">
 ...
 <a href="<?=base_url('admin/view_page/category_list');?>">
