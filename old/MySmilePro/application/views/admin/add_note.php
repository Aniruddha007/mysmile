                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <form role="form">
                                           ...
                                           <div class="form-group">
                                                <label for="exampleInputEmail1">Note(Missing for account Approve) *</label>

                                            <textarea class="form-control" required style="width:550px; height:150px;" cols="42" rows="5" name="note"><?php
...
$('.confirm').click(function(){
        ...
        window.location='".base_url('admin/view_page/driver_list_deactive')."';
});
...
if ($result) {
   ...
   $user_message_apk_ios = array(
            "message" => array(
              "result" => "successful",
              "key" =>  "Deactivate Note",
              "ios_status" => "Deactivate Note",
              "title" =>"Deactivate Note",
              "message" =>  "Deactivate Note",
              "note" => $u_note,
              "user_id" => '',
              "provider_id" =>'',
              "category_name" => '',
              ...
              "request_id" => ''
                        ...
                        $this->admin_common_model->ios_provider_notification_new($users_r[0]['ios_register_id'],$user_message_apk_ios['message']);   
