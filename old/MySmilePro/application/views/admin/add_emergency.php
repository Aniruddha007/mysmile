                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb pull-right">
                                    <li><a href="#">RESA</a></li>
                                    <li class="active">Add Emergency</li>
                                </ol>
                            </div>
                        </div>
          ...
          <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">ADD NEW Emergency</h3></div>
                                        ...
                                        <form role="form">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="duration_service" required value="<?=$row['duration_service'];?>">
                                            </div>
                                    ...
                                    <input type="hidden"  class="form-control" name="type" required value="EMERGENCY">
...
$('.confirm').click(function(){
        ...
        window.location='".base_url('admin/view_page/emergency_list')."';
});
