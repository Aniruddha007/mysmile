<?php include 'include/header.php';?>
  ...
  $button = "submit";
      ...
      $id = $this->uri->segment(4);
        ...
        $row = $fetch[0];
        $button = "update";
        $btn_name = "Update Privacy Policy";        
        if($row['image']!=''){
          ...
          <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <?php if($row['id']){?>
                                    <div class="panel-heading"><h3 class="panel-title">Update Privacy Policy</h3></div>
                                    <?php }else{?>
                                    ...
                                    <div class="panel-body">
                                        <form role="form">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <textarea class="form-control" required style="width:550px; height:150px;" cols="42" rows="5" name="privacy"><?php
  if($row['privacy']) echo $row['privacy'];
?></textarea>
                                            </div>
                                            
                                            
                                          <!--  <div class="form-group">
                                                <label for="exampleInputEmail1">Privacy Policy Arabic*</label>

                                            <textarea class="form-control" required style="width:550px; height:150px;" cols="42" rows="5" name="privacy_sp"><?php
  if($row['privacy_sp']) echo $row['privacy_sp'];
?></textarea>
                                            </div>-->
...
"<script> swal(
  'Success',
  'Update Privacy Policy Successfully',
  'success'
); 

$('.confirm').click(function(){
        window.location='".base_url('admin/view_page/privacy1')."';
});
...
echo "<script> swal(
  'Error',
  'Error In Updating Privacy Policy',
  'error'
); 
