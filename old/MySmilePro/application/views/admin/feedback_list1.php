<?php include 'include/header.php';?>
    ...
    <body class="fixed-left">
       ...
       <?php include 'include/side_menu.php';
         ...
         $req = $this->admin_common_model->get_where('rating_review',['type'=>'PROVIDER']);
...
<!--      <a href="<?=base_url('admin/view_page/ExUser?type=feedbacks');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Export csv</button></a>
-->                               
...
<div class="row">
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Feedback and Rating List</h3>
                                    </div>
    ...
    <form action="<?php echo base_url(); ?>admin/goFeedback1" method="POST" id="bulk_form" onsubmit="delete_confirm()">
                    ...
                    <input type="hidden" name="from" id="max" placeholder="12-04-2017 12:52 PM" class="form-control">
                      ...
                      $request = $this->admin_common_model->get_where('user_request',['id'=>$row['request_id']]);


                      $drivername = $this->admin_common_model->get_where('users',['id'=>$request[0]['provider_id']]);
                      
                      $username = $this->admin_common_model->get_where('users',['id'=>$request[0]['user_id']]);
                            ...
                            <td align="center"><input type="checkbox" name="checked_id[]" class="checkbox" value="<?php echo $row['id']; ?>"/></td>  
                                                                                      <td><?= $drivername[0]['first_name'].' '. $drivername[0]['last_name']; ?></td>
