<?php include 'include/header.php';?>
    ...
    <body class="fixed-left">
       ...
       <?php include 'include/side_menu.php';
                  ...
                  // $req = $this->db->query("SELECT * FROM user_request1 WHERE  status='Pending' ")->result_array();die;
...
-->                                       <!--   <a href="<?=base_url('admin/view_page/pending_ride');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Refresh</button></a>
-->
...
<div class="row">
    ...
    <form action="<?php echo base_url(); ?>admin/goRequest1" method="POST" id="bulk_form" onsubmit="delete_confirm()">
                                   ...
                                   ?>
                                              ...
                                              $date_time  = date("Y-m-d g:i a", strtotime($row['date_time']));
                                                 ...
                                                 <td class="text-center">
                                                           ...
                                                           <!-- <td class="text-center"> <a href="<?=base_url('admin/view_page/add_request/'.$row['id']);?>"><button class="btn view-t"></a> </button> <a href="<?=base_url('admin/view_page/view_complete_ride/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-eye"></i></a> </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
-->
