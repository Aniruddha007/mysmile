...
$userList = $this->admin_common_model->get_all('zone_price');
...
-->                                <ol class="breadcrumb pull-right">
                                    ...
                                    <li class="active">Zone Price List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Zone Price List</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    <thead>
                                                        <tr>
                                                            <th>Pickup Zone Name</th>
                                                            <th>Drop up Zone Name</th>
                                                            <th>Price</th>
                                              ...
                                              $zone = $this->admin_common_model->get_where('zones',['id'=>$row['pickup_zone']]);
                                              $zone1 = $this->admin_common_model->get_where('zones',['id'=>$row['dropup_zone']]);

                                              ?>

                                                        <tr>
                                                            <td><?= $zone[0]['zone_name']; ?></td>
                                                            <td><?= $zone1[0]['zone_name']; ?></td>
                                                            <td><?= $row['price']; ?></td>
                                                            <td><?= $row['priority_price']; ?></td>
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_price_zone/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>   </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
...
function(){
        ...
        $.ajax({
          ...
          data: {'table': 'zone_price', 'id': id}, // change this to send js object
          type: "POST",
