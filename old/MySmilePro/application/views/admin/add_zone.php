<?php include 'include/header.php';?>
  ...
  $button = "submit";
      ...
      if($id!=''){
        $fetch = $this->admin_common_model->get_where('zones',['id'=>$id]);
        $row = $fetch[0];
        $button = "update";
        $btn_name = "Update Zone";        
        if($row['image']!=''){
          ...
          <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">ADD NEW Zone</h3></div>
...
$result = $this->admin_common_model->insert_data('zones',$arr_data); 
...
$('.confirm').click(function(){
        ...
        window.location='".base_url('admin/view_page/zone_list')."';
});
...
$result = $this->admin_common_model->update_data('zones',$arr_data, $arr_where); 
//echo $this->db->last_query(); die;
