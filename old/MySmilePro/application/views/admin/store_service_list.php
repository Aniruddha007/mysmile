...
$userList = $this->admin_common_model->get_where('provider_services',['remove_status'=>'No','user_id'=>$id]);
...
?>
      ...
      <a href="<?=base_url('admin/view_page/driver_list');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Back</button></a>
