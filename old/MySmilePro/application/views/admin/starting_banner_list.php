...
$userList = $this->admin_common_model->get_where('intro_banner',['type'=>'USER']);
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                &nbsp;	&nbsp;	
      <a href="<?=base_url('admin/view_page/add_starting_banner');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Add New</button></a>
                                <ol class="breadcrumb pull-right">
                                    <li><a href="<?=base_url('admin/view_page/dashboard');?>">SelfCare</a></li>
                                    <li class="active">User Intro Page Banner List</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">User Intro Page Banner List</h3>
                                    </div>
                      ...
                      <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                        ...
                                        <div class="row">
										   ...
										   <td>
                                                            ...
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_starting_banner/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>   </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
