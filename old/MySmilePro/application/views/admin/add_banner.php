...
<form method="POST" action="" enctype="multipart/form-data">
          <input type="hidden"  class="form-control" name="id" value="<?=$row['id'];?>">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <?php if($row['id']){?>
                                    <div class="panel-heading"><h3 class="panel-title">Update Banner</h3></div>
                                    <?php }else{?>
                                    <div class="panel-heading"><h3 class="panel-title">Add Banner</h3></div>
                                    <?php }?>
                                    <div class="panel-body">
                                        <form role="form">
                                           ...
                                           <!-- <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Link </label>
                                                <input type="url" class="form-control" name="link"  value="<?=$row['link'];?>">
                                            </div>
 ...
 <a href="<?=base_url('admin/view_page/banner_list');?>">
...
$('.confirm').click(function(){
        ...
        window.location='".base_url('admin/view_page/banner_list')."';
});
