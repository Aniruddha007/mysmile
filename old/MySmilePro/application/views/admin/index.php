        ...
        <div class="wrapper-page">
            <div class="panel panel-color panel-primary panel-pages">
                <div class="panel-heading bg-logn bg-img"> 
                    ...
                    <img src="<?php echo base_url('assets'); ?>/images/banner/logo.png" alt="" class="img-responsive center-block" style="width:40%; height:40%; background-color:#FFFFFF">
                </div> 
          ...
          <?php include("session_msg.php");  ?>
                ...
                <form class="form-horizontal m-t-20" id="login" action="<?php echo base_url(); ?>admin/go" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control input-lg" type="text" required="" name="username" id="username" placeholder="Email">
                        </div>
                    </div>
                    ...
                    <div class="form-group text-center m-t-40">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg w-lg waves-effect waves-light bg-login-btn" type="submit" style="color:#000000  !important;background-color:#3282b7  !important;border-color: #3282b7  !important">Log In</button>
                        </div>
                    </div>
