<?php include 'include/header.php';?>
    ...
    <body class="fixed-left">
     ...
     //    $req = $this->admin_common_model->get_where('user_request',$arr_get1);
                   $req = $this->db->query("SELECT * FROM user_request WHERE  status='Accept' OR status='Start' OR status='Arrived' order by id desc ")->result_array();
...
-->                               
                                ...
                                echo $fetch_app_name[0]['app_name']; ?></a></li>
                                    <li class="active">Just Booked Request</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">JUST BOOKED , NOT YET STARTED REQUEST</h3>
                                    </div>
                                    <div class="panel-body">
                                        
                                         <section class="content">
    <form action="<?php echo base_url(); ?>admin/goRequest2" method="POST" id="bulk_form" onsubmit="delete_confirm()">
