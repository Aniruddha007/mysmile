...
?>
      ...
      <a href="<?=base_url('admin/view_page/add_banner');?>"><button type="button" class="btn btn-purple waves-effect waves-light" > Add New Banner</button></a>
                      ...
                      <i data-time-icon="icon-time" data-date-icon="icon-calendar"></i>
                                        ...
                                        <div class="row">
										   ...
										   <td>
                                                            ...
                                                            <td class="text-center"><a href="<?=base_url('admin/view_page/add_banner/'.$row['id']);?>"><button class="btn view-t"><i class="fa  fa-edit"></i></a> </button>   </button> <button class="btn delete-t"><i class="fa   fa-trash-o" onclick="deleteUsers('<?=$row["id"];?>')"></i></button></td>
